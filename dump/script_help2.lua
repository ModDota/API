...
DOTA_GAMERULES_STATE_TEAM_SHOWCASE = 4
...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 128 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 125 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 126 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 124 -- OnAbilityStart
MODIFIER_EVENT_ON_ATTACK = 117 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 134 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 120 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_FAIL = 119 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 165 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 118 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 115 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_START = 116 -- OnAttackStart
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 127 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 146 -- OnBuildingKilled
MODIFIER_EVENT_ON_DEATH = 135 -- OnDeath
MODIFIER_EVENT_ON_DOMINATED = 162 -- OnDominated
MODIFIER_EVENT_ON_HEALTH_GAINED = 141 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 145 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 144 -- OnHeroKilled
MODIFIER_EVENT_ON_MANA_GAINED = 142 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 147 -- OnModelChanged
MODIFIER_EVENT_ON_ORB_EFFECT = 133
MODIFIER_EVENT_ON_ORDER = 122 -- OnOrder
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 129
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 121 -- OnProjectileDodge
MODIFIER_EVENT_ON_REFRESH = 130
MODIFIER_EVENT_ON_RESPAWN = 136 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 140 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 114 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_MANA = 137 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 132 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 131 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 143 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 139 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 138 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 123 -- OnUnitMoved
MODIFIER_FUNCTION_INVALID = 255
MODIFIER_FUNCTION_LAST = 169
MODIFIER_PROPERTY_ABILITY_LAYOUT = 161 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 101 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 100 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 102 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 90 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 109 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT = 21 -- GetModifierAttackSpeedBonus_Constant
MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT_POWER_TREADS = 22 -- GetModifierAttackSpeedBonus_Constant_PowerTreads
MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT_SECONDARY = 23 -- GetModifierAttackSpeedBonus_Constant_Secondary
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 26 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 67 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 68 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_AVOID_DAMAGE = 40 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_SPELL = 41 -- GetModifierAvoidSpell
MODIFIER_PROPERTY_BASEATTACK_BONUSDAMAGE = 2 -- GetModifierBaseAttack_BonusDamage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 32 -- GetModifierBaseDamageOutgoing_Percentage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 33 -- GetModifierBaseDamageOutgoing_PercentageUnique
MODIFIER_PROPERTY_BASE_ATTACK_TIME_CONSTANT = 25 -- GetModifierBaseAttackTimeConstant
MODIFIER_PROPERTY_BASE_MANA_REGEN = 50 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BONUS_DAY_VISION = 93 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 94 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 95 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 96 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 112 -- GetModifierBountyCreepMultiplier
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 113 -- GetModifierBountyOtherMultiplier
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 167 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 77 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 66 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 160 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 75 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 76 -- GetModifierPercentageCooldownStacking
MODIFIER_PROPERTY_COOLDOWN_REDUCTION_CONSTANT = 24 -- GetModifierCooldownReduction_Constant
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE = 27 -- GetModifierDamageOutgoing_Percentage
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_ILLUSION = 28 -- GetModifierDamageOutgoing_Percentage_Illusion
MODIFIER_PROPERTY_DEATHGOLDCOST = 79 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 92 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 108 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 158 -- GetModifierDisableTurning
MODIFIER_PROPERTY_EVASION_CONSTANT = 38 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 60 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 62 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 61 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 59 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FIXED_DAY_VISION = 97 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 98 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 157 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_HEALTH_BONUS = 57 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 55 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 56 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 159 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 166 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_ILLUSION_LABEL = 104 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 34 -- GetModifierIncomingDamage_Percentage
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 36 -- GetModifierIncomingPhysicalDamageConstant
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 35 -- GetModifierIncomingPhysicalDamage_Percentage
MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 37 -- GetModifierIncomingSpellDamageConstant
MODIFIER_PROPERTY_INVISIBILITY_LEVEL = 8 -- GetModifierInvisibilityLevel
MODIFIER_PROPERTY_IS_ILLUSION = 103 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 151 -- GetModifierScepter
MODIFIER_PROPERTY_LIFETIME_FRACTION = 154 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 82 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 47 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 49 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_ITEM_UNIQUE = 48 -- GetModifierMagicalResistanceItemUnique
MODIFIER_PROPERTY_MAGICDAMAGEOUTGOING_PERCENTAGE = 31 -- GetModifierMagicDamageOutgoing_Percentage
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 78 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANA_BONUS = 58 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 51 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 52 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_PERCENTAGE = 53 -- GetModifierPercentageManaRegen
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 54 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 69 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MIN_HEALTH = 99 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 42 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 149 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 150 -- GetModifierModelScale
MODIFIER_PROPERTY_MOVESPEED_ABSOLUTE = 17 -- GetModifierMoveSpeed_Absolute
MODIFIER_PROPERTY_MOVESPEED_ABSOLUTE_MIN = 18 -- GetModifierMoveSpeed_AbsoluteMin
...
MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE_UNIQUE_2 = 14 -- GetModifierMoveSpeedBonus_Percentage_Unique_2
MODIFIER_PROPERTY_MOVESPEED_BONUS_UNIQUE = 15 -- GetModifierMoveSpeedBonus_Special_Boots
MODIFIER_PROPERTY_MOVESPEED_BONUS_UNIQUE_2 = 16 -- GetModifierMoveSpeedBonus_Special_Boots_2
MODIFIER_PROPERTY_MOVESPEED_LIMIT = 19 -- GetModifierMoveSpeed_Limit
MODIFIER_PROPERTY_MOVESPEED_MAX = 20 -- GetModifierMoveSpeed_Max
MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 39 -- GetModifierNegativeEvasion_Constant
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 87 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 89 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 88 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 110 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 9 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 43 -- GetModifierPhysicalArmorBonus
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_ILLUSIONS = 44 -- GetModifierPhysicalArmorBonusIllusions
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 45 -- GetModifierPhysicalArmorBonusUnique
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 46 -- GetModifierPhysicalArmorBonusUniqueActive
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 83 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 84 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 80 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 81 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 164 -- PreserveParticlesOnModelChanged
...
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 70 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 155 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_REFLECT_SPELL = 91 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 71 -- ReincarnateTime
MODIFIER_PROPERTY_RESPAWNTIME = 72 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 73 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 74 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 156 -- GetModifierSpellsRequireHP
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE = 30 -- GetModifierSpellAmplify_Percentage
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 64 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 65 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 63 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_SUPER_ILLUSION = 105 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 106 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 163 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 148 -- OnTooltip
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 29 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 86 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 85 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 152 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 153 -- GetAttackSound
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 107 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 111 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 168 -- GetVisualZDelta
...
function CDOTA_BaseNPC:PerformAttack( hTarget, bUseCastAttackOrb, bProcessProcs, bSkipCooldown, bIgnoreInvis, bUseProjectile ) end
...
-- @return bool
-- @param iPlayerID int
function CDOTA_PlayerResource:GetPlayerReservedState( iPlayerID ) end
...
-- @return bool
-- @param iPlayerID int
function CDOTA_PlayerResource:HasRepicked( iPlayerID ) end
...
-- @return void
-- @param iPlayerID int
function CDOTA_PlayerResource:SetHasRepicked( iPlayerID ) end
...
function CDOTA_PlayerResource:SetPlayerReservedState( iPlayerID, bReserved ) end
